...
export const InteractiveRinkDiagram = ({
  ...
  const getImageSource = () => {
    switch (activeTemplate) {
      ...
      case "47-point":
        return rink47Point;
      case "usa-hockey":
        return null; // Use SVG component instead
      case "custom":
      case "custom_1":
      case "custom_2":
      case "custom_3":
  ...
  const isUSAHockeyTemplate = activeTemplate === "usa-hockey";
    ...
    <div className="space-y-4">
          ...
          {devMode && (
            <>
              ...
              <SelectContent>
                ...
                <SelectItem value="usa-hockey">USA Hockey (Official)</SelectItem>
      ...
      >
        ...
        <USAHockeyRink 
          ...
          onMeasurementChange={!devMode ? onMeasurementChange : undefined}
          unit={unit}
        />
